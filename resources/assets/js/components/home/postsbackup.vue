        ...
        <div class="modal is-active" v-if="postOptions">
            ...
            <div class="modal-card">
                ...
                <section class="modal-card-body">
                    <div class="media-content">
                        <p class="control">
                            <input type="text" class="input" placeholder="Post title" maxlength="50" v-model="title">
                        </p>
                        <p class="control">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            editPost() {
                if (this.post.body != this.body || this.post.title != this.title) {
                    axios.patch('posts/'+this.post.id, {title: this.title, body: this.body}).then(response => {
                        this.postOptions = false;
